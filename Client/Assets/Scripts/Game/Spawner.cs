...
public static class Spawner
{
    public static void SpawnUnit(Game _game, UnitType _unit_type, ClassType _class_type, Hex _hex)
    {
        ...
        switch (_unit_type)
        {
            ...
            case UnitType.JESTER:
                ...
                jester_passive.illusions = new List<Unit>() { CreateIllusion(_unit), CreateIllusion(_unit) };
        ...
        if (_game != null && _unit != null && _hex != null)
        {
            ...
            _unit.game_object.transform.SetParent(GameManager.Instance.map_controller.units_container);
        }
    }
    ...
    {
        {
            ...
            _unit.game_object.transform.SetParent(GameManager.Instance.map_controller.units_container);
            if(_unit.stats.current_health <= 0)
                _unit.game_object.SetActive(false);
            #endregion
    ...
    private static Unit CreateIllusion(Unit _unit_parent)
    {
        Unit illusion;
