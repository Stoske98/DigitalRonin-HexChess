...
public static class Spawner
{
    ...
    {
        Unit unit = new Unit(_class_type, _unit_type);
        ...
        unit.game_object.transform.SetParent(GameManager.Instance.map_controller.units_container);
    ...
    private static Unit SpawnLightArcher(Game _game, Hex _hex, ClassType _class_type, UnitType _unit_type)
    {
        ...
        List<Level> levels = new List<Level>()
        {
            ...
            new Level()
            {
                ...
                behaviours_to_add = new List<Behaviour>()
                {                    
                     new Powershoot(unit, new AbilityData() 
                     { 
                         amount = 1, max_cooldown = 2, current_cooldown = 0 
                     }),
    ...
    {
        Unit illusion = new Unit(_unit_parent.class_type, _unit_parent.unit_type);
    ...
    {
        Unit stone = new Unit(class_type, UnitType.Stone);
        ...
        stone.game_object.transform.SetParent(GameManager.Instance.map_controller.units_container);
